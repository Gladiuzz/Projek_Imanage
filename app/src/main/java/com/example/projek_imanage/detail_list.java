...
public class detail_list extends AppCompatActivity {
    ...
    public String id_item ,nama_Barang, kategori ,deskripsi, tanggal, gambar_Barang, mkey,test, id_qrCode;
    public Integer jumlah, harga;
    private Item items;
    private ImageView gambarBarang;
    private EditText edtnama, edtharga,edtdetail, edtjumlah, edttgl;
    private Spinner edtkategori;
...
//        for(int i= 0; i < edtkategori.getAdapter().getCount(); i++)
//        {
//            if(edtkategori.getAdapter().getItem(i).toString().contains(kategori))
//            {
//                edtkategori.setSelection(i);
//            }
//        }

//        edtkategori.setSelection(Integer.parseInt(kategori));
    ...
    public void editData(){
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Kategori kategoriResult = (Kategori) edtkategori.getSelectedItem();
                ...
                if (mGambarUri != null){
                                    ...
                                    if (mGambarUri != null){
                                        fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                ...
                                                String id = id_item;
                                                Item item = new Item(id, Nama_item, Kategori,Deskripsi, Jumlah, Harga, Tanggal, gambar,id_qrCode);
                    ...
                    String id = id_item;
                    Item item = new Item(id, Nama_item, Kategori,Deskripsi, Jumlah, Harga, Tanggal, gambar_edt,id_qrCode);
    ...
    private void test() {
        adapter = new ArrayAdapter<Kategori>(getApplicationContext(),android.R.layout.simple_spinner_item,mKategori);
